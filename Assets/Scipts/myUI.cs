...
public sealed class myUI : Singleton<myUI> {
	...
	public void IncCreature(){countOfCreature++;
		Debug.Log("countOfCreature++");
	}
	public void IncType(){countOfTypes++;
		Debug.Log("countOfTypes++");
	}
	public void Incplant(){soilRichness++;
		Debug.Log("soilRichness++");
	}
	public void DecCreature(){countOfCreature--;
		Debug.Log("countOfCreature--");
	}
	public void DecType(){countOfTypes--;
		Debug.Log("countOfTypes--");
	}
	public void Decplant(){soilRichness--;
		Debug.Log("soilRichness--");
	}
}